                    ...
                    Padding(
                      ...
                      child: InkWell(
                        ...
                        child: Container(
                          ...
                          child: StreamBuilder<List<MajorsPlansRecord>>(
                            stream: queryMajorsPlansRecord(
                              queryBuilder: (majorsPlansRecord) =>
                                  majorsPlansRecord.where('major',
                                      isEqualTo: columnStudentsRecord!.major),
                              singleRecord: true,
                            ),
                            builder: (context, snapshot) {
                              // Customize what your widget looks like when it's loading.
                              ...
                              List<MajorsPlansRecord> rowMajorsPlansRecordList =
                                  snapshot.data!;
                              final rowMajorsPlansRecord =
                                  rowMajorsPlansRecordList.isNotEmpty
                                      ? rowMajorsPlansRecordList.first
                                      : null;
                              return InkWell(
                                onTap: () async {
                                  context.pushNamed('MajorPlan');
                                },
                                child: Row(
                                  mainAxisSize: MainAxisSize.max,
                                  children: [
                    ...
                    Padding(
                      ...
                      child: InkWell(
                        ...
                        child: Container(
                          ...
                          child: InkWell(
                            onTap: () async {
                              context.pushNamed('AvailableCourses');
                            },
                            child: Row(
                              mainAxisSize: MainAxisSize.max,
                              children: [
