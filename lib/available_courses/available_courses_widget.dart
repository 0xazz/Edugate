...
class AvailableCoursesWidget extends StatefulWidget {
  const AvailableCoursesWidget({Key? key}) : super(key: key);
            ...
            child: Padding(
              ...
              child: SingleChildScrollView(
                child: Column(
                  ...
                  children: [
                    StreamBuilder<List<SemesterCoursesRecord>>(
                      ...
                      builder: (context, snapshot) {
                        ...
                        List<SemesterCoursesRecord>
                            listViewSemesterCoursesRecordList = snapshot.data!;
                        return ListView.builder(
                          padding: EdgeInsets.zero,
                          primary: false,
                          shrinkWrap: true,
                          scrollDirection: Axis.vertical,
                          itemCount: listViewSemesterCoursesRecordList.length,
                          itemBuilder: (context, listViewIndex) {
                            final listViewSemesterCoursesRecord =
                                listViewSemesterCoursesRecordList[
                                    listViewIndex];
                            return Padding(
                              padding:
                              ...
                              child: StreamBuilder<CoursesRecord>(
                                stream: CoursesRecord.getDocument(
                                    listViewSemesterCoursesRecord.course!),
                                builder: (context, snapshot) {
                                  // Customize what your widget looks like when it's loading.
                                  if (!snapshot.hasData) {
                                    return Center(
                                            ...
                                            Padding(
                                              ...
                                              child: Row(
                                                ...
                                                children: [
                                                  Expanded(
                                                    child: Text(
                                                      '${containerPhotoBGCoursesRecord.department}',
                                                      style: FlutterFlowTheme
                                                              .of(context)
                                                          .bodyText2
                                                          .override(
                                                            ...
                                                            padding:
                                                                EdgeInsetsDirectional
                                                                    .fromSTEB(
                                                                        ...
                                                                        4),
                                                            child: Text(
                                                              'Hours: ${containerPhotoBGCoursesRecord.hours?.toString()}',
                                                              style: FlutterFlowTheme
                                                                      .of(context)
                                                                  .title3
                                                                  .override(
